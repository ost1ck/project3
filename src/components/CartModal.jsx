...
import { useCart } from '../context/CartContext'; // Замінюємо useContext на useCart

function CartModal() {
  const { cart, setCart, isCartOpen, setIsCartOpen, updateCart } = useCart(); // Використовуємо useCart
